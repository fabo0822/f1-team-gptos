export const circuitos = [
    ...
    {
      nombre: "Circuito de Barcelona-Cataluña",
      pais: "España",
      longitud_km: 4.65,
      vueltas: 66,
      descripcion: "Famoso por su mezcla de secciones técnicas y rápidas, es uno de los circuitos más completos para los pilotos.",
      record_vuelta: { tiempo: "1:18.149", piloto: "Lewis Hamilton", año: 2017 },
      ganadores: [
        { temporada: 2021, piloto: 1 },
        { temporada: 2022, piloto: 3 },
        { temporada: 2023, piloto: 2 }
      ],
      imagen: "https://upload.wikimedia.org/wikipedia/commons/d/d5/Barcelona_Circuit_2020_layout.svg"
    },
    {
      nombre: "Circuito de Bakú",
      pais: "Azerbaiyán",
      longitud_km: 6.00,
      vueltas: 51,
      descripcion: "Conocido por ser un circuito urbano de alta velocidad, con oportunidades de adelantamiento, pero también alto riesgo por las barreras cercanas.",
      record_vuelta: { tiempo: "1:43.009", piloto: "Valtteri Bottas", año: 2019 },
      ganadores: [
        { temporada: 2021, piloto: 1 },
        { temporada: 2022, piloto: 1 },
        { temporada: 2023, piloto: 1 }
      ],
      imagen: "https://upload.wikimedia.org/wikipedia/commons/a/a9/Baku_City_Circuit_2020_layout.png"
    }
  ];
